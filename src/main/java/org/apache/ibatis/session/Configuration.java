...
public class Configuration {
    ...
    /**
     * mybatis configuration 设置指定的日志实现
     *
     * @param logImpl
     */
    public void setLogImpl(Class<? extends Log> logImpl) {
        if (logImpl != null) {
            ...
            // 日志工厂增加指定的日志实现类，其实就是把 LogFactory 的 logConstructor 属性设置成当前日志实现的构造函数，创建的时候，就创建指定的日志啦
    ...
    public void setVfsImpl(Class<? extends VFS> vfsImpl) {
        if (vfsImpl != null) {
            ...
            // mybatis 的 configuration 使用指定的 vfsImpl
            // VFS 中增加指定的 vfsImpl 其他的 vfs实现类还在
    ...
    public StatementHandler newStatementHandler(Executor executor, MappedStatement mappedStatement, Object parameterObject, RowBounds rowBounds, ResultHandler resultHandler, BoundSql boundSql) {
        // 调用 RoutingStatementHandler 返回具体的执行器类型
