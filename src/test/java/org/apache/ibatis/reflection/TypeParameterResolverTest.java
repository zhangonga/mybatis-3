...
public class TypeParameterResolverTest {
    ...
    public class ClassASon<T> extends ClassA<T, T> {

    }

    @Test
    public void testType() throws NoSuchFieldException {
        ClassASon<Long> son = new ClassASon<>();
        ...
        // resolveFieldType 1， 解析字段，2，源类型
        // make 1, 原始类型，2，实际参数，3，拥有者类型
        Type type = TypeParameterResolver.resolveFieldType(field, ParameterizedTypeImpl.make(ClassASon.class, new Type[]{Long.class}, TypeParameterResolverTest.class));
        //
